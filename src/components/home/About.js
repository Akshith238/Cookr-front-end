      ...
      <Container>
        ...
        >
          ...
          <Typography variant="body1" className="sm:text-start text-center sm:text-lg font-poppins text-xs opacity-80 font-medium text-wrap text-white mb-6">
            ...
            we bring a fresh perspective and a commitment to innovation. Our passion for technology drives us to push boundaries and explore novel solutions that bridge the gap between culinary artistry and cutting-edge technology.
